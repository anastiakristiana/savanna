                    ...
                    <div class="entry-content">
                        ...
                        <div id="rev_slider" class="rev_slider main-banner-slide cstm-section" data-version="5.0">
                                ...
                                <li data-transition="fade">
                                    ...
                                    <img class=" gallery_on_mobile" src="{{ asset('assets/content/savanna/logo_banner_new.png') }}" width="550px" style="padding-top:350px;">
                                    </div>
                        ...
                        <div class="section mcb-section largest_satelite_city_pc" style="padding-top:15%; height: 100vh;display: flex;justify-content: center;align-items: center; padding-bottom:300px;background-color:hsl(0, 0%, 0%, 0); background-image:url({{asset('assets/content/savanna/largest_satelite_city_background2.png')}}); background-size: cover; background-repeat:no-repeat; background-position:center top;">
                                ...
                                <div class="items_group clearfix">
                                    ...
                                    <div class="column one column_column">
                                        <div class="column_attr">
                                            @if(app()->getLocale() === 'en')
                                                <img class="scale-with-grid" src="{{ asset('assets/content/savanna/icon_en_pc2.png') }}" width="70%" style="margin-left:0%;">
                                            @else
                                                <img class="scale-with-grid" src="{{ asset('assets/content/savanna/icon_id_pc2.png') }}" width="70%" style="margin-left:0%;">
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="section best_residence_choice" style="background-color:hsl(0, 0%, 0%, 0); background-size: cover; background-repeat:no-repeat; ">
                            <div class="section_wrapper clearfix">
                                <div class="items_group clearfix">
                                    ...
                                    <div class="column_how_it_works2">
                                        <div class="row_container">
                                            <!-- One Fourth (1/4) Column -->
                                            <div class="column one-fifth column_how_it_works">
                                                <div class="how_it_works has_border">
                                                    <div class="image"><img src="{{asset('assets/content/savanna/icon-complete.png')}}" class="scale-with-grid" width="95%"/>
                                                    </div>
                                        ...
                                        <div class="row_container">
                                            ...
                                            <div class="column one-fifth column_how_it_works">
                                                <div class="how_it_works has_border">
                                                    <div class="image"><img src="{{asset('assets/content/savanna/icon-easy.png')}}" class="scale-with-grid" width="95%">
                                                    </div>
                                            ...
                                            <div class="column one-fifth column_how_it_works">
                                                <div class="how_it_works has_border">
                                                    <div class="image"><img src="{{asset('assets/content/savanna/icon-green.png')}}" class="scale-with-grid" width="95%">
                                                    </div>
                                        ...
                                        <div class="row_container">
                                            ...
                                            <div class="column one-fifth column_how_it_works">
                                                <div class="how_it_works has_border">
                                                    <div class="image"><img src="{{asset('assets/content/savanna/icon-sound.png')}}" class="scale-with-grid" width="95%">
                                                    </div>
                                            ...
                                            <div class="column one-fifth column_how_it_works">
                                                <div class="how_it_works no_border">
                                                    <div class="image"><img src="{{asset('assets/content/savanna/icon-trusted.png')}}" class="scale-with-grid" width="95%">
                                                    </div>
...
$(document).ready(function() {
  $('.video-popup').magnificPopup({
    ...
    <script>
        $(document).ready(function() {
            // Function to set the video source based on screen size
            function setVideoSource() {
                ...
                if (screenWidth >= 1920) {
                    videoPath = '{{ asset("assets/content/savanna/vidbanner_landscape_savanna_1920x1080px.mp4") }}';
                } else if (screenWidth >= 1600) {
                    videoPath = '{{ asset("assets/content/savanna/vidbanner_landscape_savanna_1600x900px.mp4") }}';
                } else if (screenWidth >= 1366) {
                    videoPath = '{{ asset("assets/content/savanna/vidbanner_landscape_savanna_1366x768px.mp4") }}';
                } else if (screenWidth >= 1280) {
                    videoPath = '{{ asset("assets/content/savanna/vidbanner_landscape_savanna_1280x720px.mp4") }}';
                } else {
                    videoPath = '{{ asset("assets/content/savanna/vidbanner_portrait_savanna_mobile_video.mp4") }}';
                }
    
                // Set the video source and load it
                video.attr('src', videoPath);
                video[0].load(); // Use [0] to access the DOM element
            }
